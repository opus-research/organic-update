...
public class AggregateTest {
	...
	public void ccTest() throws Exception {
		...
		Assert.assertEquals(Double.valueOf(457.0), aggr.getAverageValue(MetricName.CELOC));
		Assert.assertEquals(39, aggr.getAverageValue(MetricName.MELOC).intValue());
		Assert.assertEquals(Double.valueOf(0.4347826086956521), aggr.getAverageValue(MetricName.ParameterCount));
		Assert.assertEquals(Double.valueOf(0.14423076923076922), aggr.getAverageValue(MetricName.TCC));
	}
}
